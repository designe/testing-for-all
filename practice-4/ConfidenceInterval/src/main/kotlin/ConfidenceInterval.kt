...
class ConfidenceInterval {
    ...
    fun ci95(samples: IntArray): CiResult {
        ...
        val ciMin = mean - intervalValue
        val ciMax = mean + intervalValue
    ...
    fun ci95_round(samples: IntArray, round: Int): CiResult {
        ...
        val ciMin = result.min.toBigDecimal().setScale(round, RoundingMode.CEILING).toDouble()
        val ciMax = result.max.toBigDecimal().setScale(round, RoundingMode.CEILING).toDouble()
